...
assert.equal(health.sourceSummary.byStatus.ready, 2);
...
console.log(JSON.stringify({ ok: true, health: health.sourceSummary, uc: uc.status, jianpian: { search: jianpianSearch.list.length, episodes: jianpianDetail.episodes.length, play: jianpianPlay.status } }, null, 2));
process.exit(0);
